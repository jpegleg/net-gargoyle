...
The connection collection happens at a default rate of 0.1 seconds per connection + (usually) small amount of time.  With that, it is to be noted that the collection only occurs at a rate of (Nx0.1)+(0.003) and any activity that happens between those intervals will not be detected by a single gargoyle thread.
